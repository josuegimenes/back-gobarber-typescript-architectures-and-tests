...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  constructor(appointmentsRepository, notificiationsRepository, cacheProvider) {
    this.appointmentsRepository = appointmentsRepository;
    this.notificiationsRepository = notificiationsRepository;
  ...
  async execute({
    ...
    await this.notificiationsRepository.create({
